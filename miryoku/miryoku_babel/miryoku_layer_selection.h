...
// Accents
#if !defined(MIRYOKU_LAYER_TILDE)
  #define MIRYOKU_LAYER_TILDE MIRYOKU_ALTERNATIVES_TILDE
#endif
#if !defined(MIRYOKU_LAYERMAPPING_TILDE)
  #define MIRYOKU_LAYERMAPPING_TILDE MIRYOKU_MAPPING
#endif